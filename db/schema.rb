...
ActiveRecord::Schema.define(version: 20151118060004) do
  ...
  create_table "games_people", force: :cascade do |t|
    t.integer "game_id"
    t.integer "person_id"
  end

  add_index "games_people", ["game_id"], name: "index_games_people_on_game_id"
  add_index "games_people", ["person_id"], name: "index_games_people_on_person_id"
